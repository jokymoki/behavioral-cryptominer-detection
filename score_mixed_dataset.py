...
from score_windows import TCNForecaster, compute_basic_scores
from step3_make_windows import make_windows


BASE_DIR = Path(__file__).resolve().parent
CLEAN_MIXED_DIR = BASE_DIR / "clean_data" / "mixed"
CLEAN_NORMAL_DIR = BASE_DIR / "clean_data" / "normal"
DATASET_PATH = BASE_DIR / "datasets" / "windows_T120_H10_S10.npz"
...
def main() -> None:
    ...
    print(f"Event rule: at least {MIN_CONSECUTIVE} consecutive positive windows")
    print()
    ...
    results = {
        ...
        "min_consecutive_windows_for_event": MIN_CONSECUTIVE,
        "aggregate_metrics": {
